                ...
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-6">
                            ...
                            <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>abczyz</p>
                            <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>abczyz</p>
                            <p className="mb-2"><i className="fa fa-envelope me-3"></i>abczyz </p>
                    ...
                    <div className="copyright">
                        <div className="row">
                            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0 d-flex">
                                &copy; 2024, Bản quyền thuộc về <a className="border-bottom nav-link ms-2" href="#">Kaida</a>
                            </div>
                        </div>
                    </div>
                </div>
